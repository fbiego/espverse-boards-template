...
public:
    ...
    GC9309SpiPanel()
    {
        ...
        static Arduino_DataBus *bus = new Arduino_ESP32SPIDMA(
            TFT_DC /* DC */, TFT_CS /* CS */, TFT_SCLK /* SCK */, TFT_MOSI /* MOSI */, TFT_MISO /* MISO */, TFT_SPI_HOST, true);
        gfx = new Arduino_GC9309(bus, TFT_RST /* RST */, 0 /* rotation */, false /* IPS */, SCREEN_WIDTH /* width */, SCREEN_HEIGHT /* height */);
    ...
    digitalWrite(LCD_IM1, LCD_IM1_STATE);
        ...
        digitalWrite(LCD_EN, LCD_EN_STATE);
#endif
